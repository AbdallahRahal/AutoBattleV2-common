...
export const BOULE_DE_FEU_INSTANT_DAMAGE = 35;
...
export const REFLEXE_DAMAGE = 23;

// 14 - Brûlure Sacrée
export const BRULURE_SACREE_CONVERT_PERCENT = 70;

// 15 - Impact
export const IMPACT_COOLDOWN = 2;
...
// 23 - Drain Spirituel
export const DRAIN_SPIRITUEL_COOLDOWN = 2;
...
export const VIREVOLTE_6_CONVERSION_PERCENT = 50;
...
export const PACTE_DE_SANG_HP_SACRIFICE_PERCENT = 6.5;
...
// 39 - Morsure Infectée
export const MORSURE_INFECTEE_COOLDOWN = 2;
...
export const SANG_DE_LA_BETE_DAMAGE = 135;
...
export const DEFERLANTE_SAUVAGE_FRENESIE_CHARGES_ADDED_PERCENT = 75;
...
// 53 - Bonne Fortune
export const BONNE_FORTUNE_COOLDOWN = 2;
export const BONNE_FORTUNE_INITIAL_COOLDOWN = 1;
export const BONNE_FORTUNE_BASE_DAMAGE = 100;
...
export const EPEE_DIVINE_BASE_DAMAGE = 20;
export const EPEE_DIVINE_BASE_HEAL = 20;
...
export const MILLES_SERVITEURS_BASE_DAMAGE = 30;
...
export const ZEPHYR_BASE_DAMAGE = 30;
export const ZEPHYR_DAMAGE_PER_RANK = 3;
export const ZEPHYR_MAX_PROCS_PER_TURN = 2;
